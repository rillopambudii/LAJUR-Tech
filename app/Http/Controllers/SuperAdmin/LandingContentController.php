...
class LandingContentController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $data = $request->validate([
            ...
            'reviews_eyebrow' => ['nullable', 'string', 'max:40'],
            'reviews_title' => ['nullable', 'string', 'max:150'],
            'reviews_text' => ['nullable', 'string', 'max:600'],
            'reviews_items' => ['nullable', 'array'],
            'reviews_items.*' => ['nullable', 'string', 'max:250'],
            'reviews_caption' => ['nullable', 'string', 'max:100'],
